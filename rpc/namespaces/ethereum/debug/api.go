...
// TraceCall executes a debug trace against a call at a given block.
// This is the debug_traceCall method required by Blockscout and Tenderly.
func (a *API) TraceCall(args evmtypes.TransactionArgs, blockNrOrHash rpctypes.BlockNumberOrHash, config *evmtypes.TraceConfig) (interface{}, error) {
	...
	a.logger.Debug("debug_traceCall", "block", blockNr)
	return a.backend.TraceCall(args, blockNr, config)
}
