...
// TraceCall executes a debug trace on an eth_call-style invocation and returns
// structured logs. This is the backend for debug_traceCall.
func (b *Backend) TraceCall(
	...
	// Execute the call via EthCall and return trace-compatible output
	...
	return map[string]interface{}{
		"gas":         res.GasUsed,
		"returnValue": common.Bytes2Hex(res.Ret),
		"failed":      res.Failed(),
	}, nil
}
