...
// RPCFilterTimeout returns the configured filter inactivity timeout.
func (b *Backend) RPCFilterTimeout() time.Duration {
	if b.cfg.JSONRPC.FilterTimeout > 0 {
		return b.cfg.JSONRPC.FilterTimeout
	}
