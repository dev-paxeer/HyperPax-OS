...
func (b *Backend) FeeHistory(
	...
	for blockID := blockStart; blockID <= blockEnd; blockID++ {
		...
		// build eth block from already-fetched tendermint data (avoids double-fetch)
		ethBlock, err := b.RPCBlockFromTendermintBlock(tendermintblock, tendermintBlockResult, true)
		if ethBlock == nil {
			return nil, err
		}
