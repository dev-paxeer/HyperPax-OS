...
// AppModuleBasic defines the basic application module for attestor.
...
// AppModule implements an application module for the attestor module.
...
// NewHandler returns the attestor module's sdk.Handler. Routes
// MsgUpdateTEERoots to the keeper's gov-gated msg_server.
