...
var (
	...
	// ErrInvalidEIP7702Height returns an error if a non-positive height is
	// stored as the EIP-7702 activation block.
	ErrInvalidEIP7702Height = errorsmod.Register(ModuleName, codeErrInvalidEIP7702Height, "invalid EIP-7702 activation height")
)
