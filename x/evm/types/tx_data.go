...
var (
	...
	// v20-agent-foundations: EIP-7702 transaction type 0x04.
	_ TxData = &SetCodeTx{}
)
...
func NewTxDataFromTx(tx *ethtypes.Transaction) (TxData, error) {
	...
	case ethtypes.SetCodeTxType:
		// v20-agent-foundations: EIP-7702 (type 0x04). Activation-block
		// gating happens at the ante decorator + state_transition.go;
		// here we just convert wire format to wrapper.
